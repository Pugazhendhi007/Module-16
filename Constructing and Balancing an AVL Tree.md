...
Thus, the Python program for constructing an **AVL tree**, balance it, and print the nodes **before and after balancing** using the appropriate packages and built-in function is executed successfully.
